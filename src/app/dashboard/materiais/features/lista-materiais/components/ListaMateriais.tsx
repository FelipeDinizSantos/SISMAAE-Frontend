...
export default function ListaMateriais({
  ...
  const { itensPaginados, paginaAtual, setPaginaAtual, totalPaginas } =
    usePaginacao(itensPorPagina, materiaisEditaveis);
      ...
      {loading || !materiaisEditaveis ? (
        ...
        <div className="tabela-wrapper">
              ...
              {itensPaginados.map((mat, idx) => {
                ...
                return (
                  <tr key={realIndex}>
                    ...
                    <td>{mat.SN}</td>
                    <td
                      className={`status ${mat.Disponibilidade.toLowerCase()}`}
                    >
                      {mat.editando ? (
                        <select
                    ...
                    <td>
                      {mat.editando && podeEditar("materiais", "omAtual") ? (
                        <select
                          value={mat.OM_Atual}
                          onChange={(e) =>
                            handleOmAtualChange(realIndex, e.target.value)
                          }
                          className="select-disponibilidade"
                        >
                        ...
                        <span>
                          {batalhoes.find(
                            (b) => String(b.id) === String(mat.OM_Atual)
                          )?.sigla || mat.OM_Atual}
                        </span>
                      )}
                    </td>
          ...
          <div className="info-paginacao">
            Mostrando {itensPaginados.length} de {materiaisEditaveis.length}{" "}
            materiais
          </div>
