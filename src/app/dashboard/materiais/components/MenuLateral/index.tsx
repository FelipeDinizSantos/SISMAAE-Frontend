...
export default function MenuLateral({
  ...
  const handleAuxiliarBuscaEspecifica = (
    event: React.ChangeEvent<HTMLSelectElement>
  ) => {
    ...
    if (buscaGeral === "MATERIAL") {
      ...
      if (buscaEspecifica === "DISPONIBILIDADE")
        setContextoLista("MATERIAL-DISPONIBILIDADE");
    }
    ...
    <section className="menu-lateral">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {buscaGeral === "MATERIAL" && buscaEspecifica === "DISPONIBILIDADE" && (
          <>
            <label htmlFor="filtro-auxiliar-especifico">
        ...
        <button
          ...
          className="buscar-outro-material"
        >
          Mudar material
        </button>
      </form>
